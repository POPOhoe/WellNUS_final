...
const PLAYLIST = [
  new PlaylistItem(
    "Sleep - Day 1",
    require("../MeditationTracks/Sleep/Day1.mp3"),
    false,
    ""
  ),
  new PlaylistItem(
    "Sleep - Day 2",
    require("../MeditationTracks/Sleep/Day2.mp3"),
    false,
    ""
  ),
  new PlaylistItem(
    "Sleep - Day 3",
    require("../MeditationTracks/Sleep/Day3.mp3"),
    false,
    ""
  ),
  new PlaylistItem(
    "Sleep - Day 4",
    require("../MeditationTracks/Sleep/Day4.mp3"),
    false,
    ""
  ),
  new PlaylistItem(
    "Sleep - Day 5",
    require("../MeditationTracks/Sleep/Day5.mp3"),
    false,
    ""
  ),
];
...
export class Player7 extends React.Component {
  constructor(props) {
    super(props);
    this.index = 0;
      ...
      <View style={styles.container}>
        ...
        <View style={styles.videoContainer}>
          ...
          <Image
            ...
            source={{
              uri: "https://cdn.dribbble.com/users/1787323/screenshots/15288432/media/6eeb9ff58cfbd90ab5213b4327be8fbe.png?compress=1&resize=1600x1200",
            }}
          />
        </View>
        <View
