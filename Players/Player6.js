...
const PLAYLIST = [
  new PlaylistItem(
    "Productivity - Day 1",
    require("../MeditationTracks/Productivity/Day1.mp3"),
    false,
    ""
  ),
  new PlaylistItem(
    "Managing Depression - Day 2",
    require("../MeditationTracks/Productivity/Day2.mp3"),
    false,
    ""
  ),
  new PlaylistItem(
    "Managing Depression - Day 3",
    require("../MeditationTracks/Productivity/Day3.mp3"),
    false,
    ""
  ),
  new PlaylistItem(
    "Managing Depression- Day 4",
    require("../MeditationTracks/Productivity/Day4.mp3"),
    false,
    ""
  ),
  new PlaylistItem(
    "Managing Depression - Day 5",
    require("../MeditationTracks/Productivity/Day5.mp3"),
    false,
    ""
  ),
];
...
export class Player6 extends React.Component {
  constructor(props) {
    super(props);
    this.index = 0;
      ...
      <View style={styles.container}>
        ...
        <View style={styles.videoContainer}>
          ...
          <Image
            ...
            source={{
              uri: "https://cdn.dribbble.com/users/1787323/screenshots/15325939/media/a2be928d68db024fe753e4ab3f08c48f.png?compress=1&resize=1600x1200",
            }}
          />
        </View>
        <View
