...
class PlaylistItem {
  constructor(name, uri, isVideo, albumArt) {
    this.name = name;
    this.uri = uri;
...
const PLAYLIST = [
  new PlaylistItem(
    "Managing Depression - Day 1",
    require("../MeditationTracks/Depression/Day1.mp3"),
    false,
    ""
  ),
  new PlaylistItem(
    "Managing Depression - Day 2",
    require("../MeditationTracks/Depression/Day2.mp3"),
    false,
    ""
  ),
  new PlaylistItem(
    "Managing Depression - Day 3",
    require("../MeditationTracks/Depression/Day3.mp3"),
    false,
    ""
  ),
  new PlaylistItem(
    "Managing Depression- Day 4",
    require("../MeditationTracks/Depression/Day4.mp3"),
    false,
    ""
  ),
  new PlaylistItem(
    "Managing Depression - Day 5",
    require("../MeditationTracks/Depression/Day5.mp3"),
    false,
    ""
  ),
];
...
export class Player5 extends React.Component {
  constructor(props) {
    super(props);
    this.index = 0;
      ...
      <View style={styles.container}>
        ...
        <View style={styles.videoContainer}>
          ...
          <Image
            ...
            source={{
              uri: "https://cdn.dribbble.com/users/1787323/screenshots/15915054/media/014440e29758146d2480a5aede592540.png?compress=1&resize=1600x1200",
            }}
          />
        </View>
        <View
        ...
        >
          ...
          <View style={styles.timestampRow}>
            <Text>{this.state.isBuffering ? BUFFERING_STRING : ""}</Text>
            ...
            >
              ...
              >
                <View style={styles.button}>
                  <Text>Poster: {this.state.poster ? "yes" : "no"}</Text>
                </View>
              </TouchableHighlight>
              <View />
              <TouchableHighlight
