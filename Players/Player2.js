...
const PLAYLIST = [
  new PlaylistItem(
    "Basics of Meditation - Day 1",
    require("../MeditationTracks/Basics/Day1.mp3"),
    false,
    ""
  ),
  new PlaylistItem(
    "Basics of Meditation - Day 2",
    require("../MeditationTracks/Basics/Day2.mp3"),
    false,
    ""
  ),
  new PlaylistItem(
    "Basics of Meditation - Day 3",
    require("../MeditationTracks/Basics/Day3.mp3"),
    false,
    ""
  ),
  new PlaylistItem(
    "Basics of Meditation - Day 4",
    require("../MeditationTracks/Basics/Day4.mp3"),
    false,
    ""
  ),
  new PlaylistItem(
    "Basics of Meditation - Day 5",
    require("../MeditationTracks/Basics/Day5.mp3"),
    false,
    ""
  ),
];
      ...
      <View style={styles.container}>
        ...
        <View style={styles.videoContainer}>
          ...
          <Image
            ...
            source={{
              uri: "https://cdn.dribbble.com/users/1787323/screenshots/14727944/media/82d686e566fe5a5141d8db9fbfbd3def.png?compress=1&resize=1600x1200",
            }}
          />
        </View>
        <View
