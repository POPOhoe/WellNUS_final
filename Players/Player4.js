...
const PLAYLIST = [
  new PlaylistItem(
    "Managing Anxiety - Day 1",
    require("../MeditationTracks/Anxiety/Day1.mp3"),
    false,
    ""
  ),
  new PlaylistItem(
    "Managing Anxiety - Day 2",
    require("../MeditationTracks/Anxiety/Day2.mp3"),
    false,
    ""
  ),
  new PlaylistItem(
    "Managing Anxiety - Day 3",
    require("../MeditationTracks/Anxiety/Day3.mp3"),
    false,
    ""
  ),
  new PlaylistItem(
    "Managing Anxiety - Day 4",
    require("../MeditationTracks/Anxiety/Day4.mp3"),
    false,
    ""
  ),
  new PlaylistItem(
    "Managing Anxiety - Day 5",
    require("../MeditationTracks/Anxiety/Day5.mp3"),
    false,
    ""
  ),
];
...
export class Player4 extends React.Component {
  constructor(props) {
    super(props);
    this.index = 0;
      ...
      <View style={styles.container}>
        ...
        <View style={styles.videoContainer}>
          ...
          <Image
            ...
            source={{
              uri: "https://cdn.dribbble.com/users/1787323/screenshots/14331984/media/e79fff6f3c84144fea5f27727837d1d7.png?compress=1&resize=1600x1200",
            }}
          />
        </View>
        <View
